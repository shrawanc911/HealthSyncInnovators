...
const LanguageSelector = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <div className="relative p-8 bg-white rounded-xl shadow-2xl max-w-md w-full border border-gray-100">
        ...
        <h2 className="text-3xl font-bold text-center mb-2 mt-6 text-gray-800">
          Health Chat
        </h2>
